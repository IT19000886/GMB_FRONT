...
componentDidMount(){
  ...
  //     {name:'Plantation Shutter', CT2:['POWDER COAT TIMBER', 'STAIN ON TIMBER','Aluminium','PVC WITH ALUMINIUM INSERT'], CT3:['SLATS 89mm', 'SLATS 63mm', 'SLATS 114mm']},
...
onFormSubmit(e){
  ...
  const addorders = {tempClientID,location, locationCode, SOM, coveringType1, coveringType2, coveringType3,
    ...
    axios.post('http://localhost:4000/api/order/order', addorders)
      .then(res => {
          this.setState({
              visible : true,
              tempClientID:"",
  ...
  render(){
    return (
      ...
      <div className="container fluid py-2">
        ...
        <button type="submit" class="btn btn-primary float-left">Add Order</button>
        </div>
        </form> 
